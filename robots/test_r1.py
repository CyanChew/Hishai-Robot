...
import sys
sys.path.append("/home/luka/R1_maniskill/R1_in_maniskill/envs/")  # 确保能找到 mani_skill 包
sys.path.append("/home/luka/R1_maniskill/R1_in_maniskill/robots/")  # 确保能找到 robots 包
# —— 先导入以完成“注册”动作 —— #
